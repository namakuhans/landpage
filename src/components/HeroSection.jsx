...
function HeroSection() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="relative flex flex-col items-center justify-center -rotate-[8deg] pointer-events-auto">
          ...
          <motion.div
            ...
            className="flex flex-col items-center justify-center font-black italic tracking-tighter text-white leading-[0.85] pointer-events-none w-full px-4 gap-y-4 lg:gap-y-6"
          ...
          >
            ...
            <div className="flex w-full justify-center relative z-10 drop-shadow-[0_10px_10px_rgba(0,0,0,0.7)] -translate-x-6 md:-translate-x-10 lg:-translate-x-12">
              <motion.span
                ...
                className="text-[6.5rem] sm:text-[10rem] md:text-[13rem] lg:text-[16rem] uppercase whitespace-nowrap text-center"
              >
                To My
              </motion.span>
            </div>
            <div className="flex w-full justify-center relative z-20 drop-shadow-[0_15px_15px_rgba(0,0,0,0.95)] -translate-x-6 md:-translate-x-10 lg:-translate-x-12">
              <motion.span
                ...
                className="text-[3rem] sm:text-[4.5rem] md:text-[5.5rem] lg:text-[7.2rem] uppercase whitespace-nowrap text-center"
              >
                Landing Page
              </motion.span>
            </div>
