    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          className="flex flex-col items-center justify-center tracking-wide text-hero-text leading-[0.85] pointer-events-none w-full px-4"
          style={{ fontFamily: "'Luckiest Guy', cursive", transform: 'rotate(-5deg)' }}
        >
